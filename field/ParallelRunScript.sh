...
function do_job {
    ...
    #echo $dat_filestem
    echo $twofiles
    nohup matlab -nodisplay -nodesktop -r "try; arena_v2($twofiles); catch ex; disp(getReport(ex)); disp(\"Params: $twofiles\"); end; quit;"
    #nohup matlab -nodisplay -nodesktop -r "tic;aashmanUpdated($twofiles); toc;exit"
